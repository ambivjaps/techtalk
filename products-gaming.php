<title> Product Reviews: Gaming Console | TechTalk </title>

<?php
	require 'layouts/header.php';
	include 'includes/dbh.inc.php';

	$sql = "SELECT * FROM product WHERE p_type='Gaming Console' ORDER BY p_id DESC";
	...
	<div class='row mt-2'>
			<nav class='category-nav'>
				<ul class='nav nav-pills nav-fill'>
	       		 	...
	       		 	<li class='nav-item'> <a class='nav-link' href='products-smartphone.php'> Smartphone </a> </li>
	        		<li class='nav-item'> <a class='nav-link active' href='products-gaming.php'> Gaming Console </a> </li>
