<title> Product Reviews: Accessory | TechTalk </title>

<?php
	require 'layouts/header.php';
	include 'includes/dbh.inc.php';

	$sql = "SELECT * FROM product WHERE p_type='Accessory' ORDER BY p_id DESC";
	...
	<div class='row mt-2'>
			<nav class='category-nav'>
				<ul class='nav nav-pills nav-fill'>
	        		...
	        		<li class='nav-item'> <a class='nav-link active' href='products-accessory.php'> Accessory </a> </li>
	      		</ul><hr>
	   	 	</nav>
